...
- 他分野の術語を，一般的な比喩として転用しない．
  -　例：正本，契約，憲法などの言葉を法学以外で用いない
- 日本語文中への英単語の挿入は，略語や固有名詞，または日本語訳が定まっていない専門用語に限り，定訳がある専門用語や一般的な単語および表現は日本語で書く．
- 細部の説明中に，大局的な意義，主観的評価，または一般化を突然挿入しない．
- 太字，絵文字，定型的な見出し，まとめ，対比構文，および箇条書きを機械的に追加しない．
- 意味が曖昧になる口語表現や崩した言い方は避ける一方で，会話や一般向け文章を不必要に硬くしない．
